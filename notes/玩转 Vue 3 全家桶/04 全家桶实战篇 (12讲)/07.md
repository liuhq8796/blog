...
关于导航守卫的 API，你可以从 Vue Router 的官网看到很详细的[介绍](https://router.vuejs.org/zh/guide/advanced/navigation-guards.html)。这里我们实际应用下，下面的代码中，我们在 router.beforeEach 函数中设置一个全局的守卫。
